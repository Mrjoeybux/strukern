#ifndef GEDKERNEL
#define GEDKERNEL
#include "../domain/my_edit_costs.h"
...
private:
  function<EditCosts<ged::GXLLabel, ged::GXLLabel> *(GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &, const KernelParams &)>
      edit_cost_init;
...
public:
  ...
  EditCosts<ged::GXLLabel, ged::GXLLabel> *init_EditCosts_MABTS(GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &env,
                                                                const KernelParams &params) const;

  void init_Method_BIPARTITE(GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &env, const KernelParams &params) const;
...
GEDKernel::GEDKernel(const GEDEditCosts &edit_costs, const GEDMethods &method, const string &graph_directory) {
  switch (edit_costs) {
  case GEDEditCosts::MABTS:
    this->edit_cost_init = [this](GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &env, const KernelParams &params) {
  ...
  case GEDMethods::BIPARTITE:
    this->method_init = [this](GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &env, const KernelParams &params) {
...
EditCosts<ged::GXLLabel, ged::GXLLabel> *GEDKernel::init_edit_costs(GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &env,
                                                                    const KernelParams &params) const {
  return this->edit_cost_init(env, params);
}

void GEDKernel::init_methods(GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &env, const KernelParams &params) const {
...
double GEDKernel::dot(const string &x1, const string &x2, const KernelParams &params) const {
  ...
  GEDGraph::GraphID id1 = env.load_gxl_graph(this->graph_dir, x1, Options::GXLNodeEdgeType::LABELED, Options::GXLNodeEdgeType::LABELED,
                                             std::unordered_set<std::string>(), std::unordered_set<std::string>());
  GEDGraph::GraphID id2 = env.load_gxl_graph(this->graph_dir, x2, Options::GXLNodeEdgeType::LABELED, Options::GXLNodeEdgeType::LABELED,
                                             std::unordered_set<std::string>(), std::unordered_set<std::string>());
...
EditCosts<ged::GXLLabel, ged::GXLLabel> *GEDKernel::init_EditCosts_MABTS(GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &env,
                                                                         const KernelParams &params) const {
...
void GEDKernel::init_Method_BIPARTITE(GEDEnv<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel> &env, const KernelParams &params) const {
